...
2. Keep the diff minimal: fix one thing per pull request.
3. Test your build locally before opening the PR:
   - GUI and service build cleanly in Visual Studio (x64)
   - the app starts, connects to the service, and saves/loads its config
4. Open a pull request with a short description of **what** changed and
   **why**.
